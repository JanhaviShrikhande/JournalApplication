...
import net.fullStack.journalApp.entity.JournalEntry;
import net.fullStack.journalApp.entity.User;
import net.fullStack.journalApp.service.JournalEntryService;
...
public class JournalEntryControllerV2 {
    ...
    public ResponseEntity<?> getAllJournalEntriesOfUser() {
        ...
        if (all != null && !all.isEmpty()) {
            return new ResponseEntity<>(all, HttpStatus.OK);  // ✅ Return the list
        }

        return new ResponseEntity<>("No journal entries found", HttpStatus.NOT_FOUND); // ✅ Return message
    }
